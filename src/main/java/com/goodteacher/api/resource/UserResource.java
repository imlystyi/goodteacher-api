...
//
//import com.goodteacher.api.dto.UserNameDto;
...
//     *
//     * @param name The name of the user to find, represented as {@link UserNameDto}.
//     * @return If the user was successfully found, {@link ResponseEntity} with HTTP status 302 "Found" and the found
//     * user as {@link UserDto} as the response body;<br>
//     * otherwise, result depends on problem.</br>
//     */
//    @GetMapping("/find/name")
//    public ResponseEntity<Set<UserDto>> findAllByName(final @RequestBody @Valid UserNameDto name) {
...
//                                              final @RequestBody @Valid UserNameDto userNameDto) {
//        final UserDto updatedUserDto = this.userService.updateName(id, userNameDto);
//
